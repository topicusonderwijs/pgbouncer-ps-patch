...
if [ $patchstatus -eq 1 ]; then
   ...
   echo "      - last tested with pgbouncer v1.18.0 (Dec 2022)"
   echo "      - Try getting pgbouncer with: git clone https://github.com/pgbouncer/pgbouncer.git --branch \"pgbouncer_1_18_0\""
